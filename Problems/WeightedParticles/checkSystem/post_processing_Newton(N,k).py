...
#    resnorm_t100_N10000000= np.loadtxt('Newton/resnorm_Dte-1_N10000000')  
    ...
    resnorm_m1= np.loadtxt('Newton/resnorm_Dte-2_tole-4_Ne6m1')
    resnorm_m2= np.loadtxt('Newton/resnorm_Dte-2_tole-4_Ne6m2')
    resnorm_m3= np.loadtxt('Newton/resnorm_Dte-2_tole-4_Ne6m3')
    resnorm_m4= np.loadtxt('Newton/resnorm_Dte-2_tole-4_Ne6m4')
    resnorm_m5= np.loadtxt('Newton/resnorm_Dte-2_tole-4_Ne6m5')
    
    
    NEW_resnorm_t10_tol2_N1000 = np.loadtxt('Newton/new_method_resnorm_Dte-2_tole-4_N1000')
    NEW_resnorm_t10_tol2_N10000 = np.loadtxt('Newton/new_method_resnorm_Dte-2_tole-4_N10000') 
    NEW_resnorm_t10_tol2_N100000 = np.loadtxt('Newton/new_method_resnorm_Dte-2_tole-4_N100000') 
    NEW_resnorm_t10_tol2_N1000000 = np.loadtxt('Newton/new_method_resnorm_Dte-2_tole-4_N1000000')  
    NEW_resnorm_t10_tol2_N10000000= np.loadtxt('Newton/new_method_resnorm_Dte-2_tole-4_N10000000')  
...
#    
#    
#    plt.plot(resnorm_t10_N1000000_newmethod, 'cyan')
#    plt.plot( resnorm_m1,  "g--")
#    plt.plot( resnorm_m2, "r--")
#    plt.plot( resnorm_m3,"y--" )
#    plt.plot( resnorm_m4, "c--"  )    
#    plt.plot(  resnorm_m5, "b--" )  
 

#    
#    plt.xlabel(r'$k$', fontsize = 14)
#    plt.ylabel(r'$||  \rho - \Phi^N_T(\rho)||$'  , fontsize = 15)
#  #  plt.savefig('resnorm_Dte-2_tole-4_Ne6_M5.pdf')
#    plt.show()

      

    plt.plot(NEW_resnorm_t10_tol2_N1000,  "g-", label=r'$N=10^3$')
    plt.plot( NEW_resnorm_t10_tol2_N10000, "r-",label = r'$N=10^4$')
    plt.plot( NEW_resnorm_t10_tol2_N100000,"y-" , label= r'$N=10^5$')
    plt.plot(  NEW_resnorm_t10_tol2_N1000000, "c-" , label = r'$N=10^6$')    
    plt.plot(  NEW_resnorm_t10_tol2_N10000000, "b-" , label = r'$N=10^7$')   
